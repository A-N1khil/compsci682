...
Code: [assignment1/knn.ipynb](assignment1/knn.ipynb)

## Q2: Training a Support Vector Machine (25 points)
The Notebook svm.ipynb will walk you through implementing the SVM classifier.  
Code: [assignment1/svm.ipynb](assignment1/svm.ipynb)

## Q3: Implement a Softmax classifier (20 points)
The Notebook softmax.ipynb will walk you through implementing the Softmax classifier.  
Code: [assignment1/softmax.ipynb](assignment1/softmax.ipynb)
...
Code: [assignment1/two_layer_net.ipynb](assignment1/two_layer_net.ipynb)
...
Code: [assignment1/features.ipynb](assignment1/features.ipynb)
